        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-[hsl(var(--primary))] rounded-full flex items-center justify-center hover:opacity-90 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div>
                  <p className="text-gray-300">123 Beauty Lane</p>
                  <p className="text-gray-300">Suite 100</p>
                  <p className="text-gray-300">Beauty City, BC 12345</p>
                </div>
              </div>
